...
### Device Tracker
Create a new [template device tracker](https://www.home-assistant.io/integrations/template/#device-tracker) in Home Assistant and link the `Latitude`, `Longitude` and `Location Accuracy` Car Assistant entities to be able to display your car on the map
