...
void loadConfig() {
  ...
  bluetoothobdmqttethanolPercent = doc["bluetoothobdmqttethanolPercent"] | "obd-ethonol-percent";
  ...
  SerialMon.println("  bluetoothobdmqttethanolPercent: " + bluetoothobdmqttethanolPercent);
